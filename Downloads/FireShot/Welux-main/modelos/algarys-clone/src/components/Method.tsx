...
export default function Method() {
  ...
  return (
    <section id="metodologia" className="section-px pt-[70px] pb-[50px] md:pt-[120px] md:pb-[70px] scroll-mt-25">
      <div className="section-container flex flex-col items-center gap-[40px] md:gap-[64px]">
