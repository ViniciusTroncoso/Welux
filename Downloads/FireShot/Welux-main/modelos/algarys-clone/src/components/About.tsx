  ...
  return (
    <>
      <p className={className}>
        ...
        O mercado está cheio de agências adicionando "IA" no nome. A Welux não se adaptou à IA —{" "}
        <span className="text-white">nascemos nela.</span>{" "}
        Não atuamos com soluções genéricas. Foco único: estruturar, desenvolver e acompanhar sistemas de IA que geram{" "}
        <span className="text-white">impacto financeiro mensurável na operação.</span>
      </p>
      <p className={className}>
        Fundada por{" "}
        <span className="text-white">Júlio Matzenbacher e Eduardo Melo,</span>{" "}
        <span className="text-white">a Welux opera desde Brasília como uma Software House de Inteligência Artificial para negócios.</span>{" "}
        Nosso time é composto por Engenheiros de Software, Analistas de Dados e Product Owners seniores. Profundidade técnica real para problemas corporativos complexos — não por quem aprendeu numa ferramenta de automação no-code.
      </p>
    </>
  );
}
...
export default function About() {
  ...
  return (
    <>
      ...
      {/* Mobile */}
      <section className="flex flex-col items-center gap-[38px] scroll-mt-25 border-y border-border bg-surface/90 px-[24px] pt-[40px] pb-[55px] backdrop-blur-[20px] md:hidden">
